                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 md:gap-10 md:px-10 border-b py-5'>
                    <div>
                        <label className="label">
                            <span className="label-text font-bold text-primary">Branch</span>
                        </label>
                        ...
                        })} defaultValue="" className="select select-bordered w-64">
                    ...
                    <div>
                        <label className="label">
                            <span className="label-text font-bold text-primary">Session length</span>
                        </label>
                    ...
                    <div>
                        <label className="label">
                            <span className="label-text font-bold text-primary">Consultant</span>
                        </label>
